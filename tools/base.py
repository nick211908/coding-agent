...
class FileDiff:
    ...
    def to_diff(self) -> str:
        ...
        #here /dev/null is used when one of the list is empty either old_line or new_line
...
class Tool(abc.ABC):
    ...
    async def get_confirmation(
        ...
        return ToolConfirmation(
            ...
            description=f"Execute {self.name} in {invocation.cwd} used for {self.description}",
        )

    def to_openai_schema(self) -> dict[str, Any]:
        #There can be two cases - schema is pydatic type(builtin tools) - schema could be dict type(mcp tools)
        ...
        #either there will be parameters key
